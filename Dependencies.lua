...
IncludeDir["Box2D"] = "%{wks.location}/Lisa/vendor/Box2D/include"
IncludeDir["filewatch"] = "%{wks.location}/Lisa/vendor/filewatch"
...
IncludeDir["mono"] = "%{wks.location}/Lisa/vendor/mono/include"
...
IncludeDir["msdfgen"] = "%{wks.location}/Lisa/vendor/msdf-atlas-gen/msdfgen"
IncludeDir["msdf_atlas_gen"] = "%{wks.location}/Lisa/vendor/msdf-atlas-gen/msdf-atlas-gen"

LibraryDir = {}

LibraryDir["VulkanSDK"] = "%{VULKAN_SDK}/Lib"
LibraryDir["mono"] = "%{wks.location}/Lisa/vendor/mono/lib/%{cfg.buildcfg}"
