...
void Sandbox2D::OnAttach()
{
	...
	m_FlatColorShader = Lisa::Shader::Create("assets/shaders/FlatColor.glsl");
}
...
void Sandbox2D::OnUpdate(Lisa::Timestep ts)
{
	...
	std::dynamic_pointer_cast<Lisa::OpenGLShader>(m_FlatColorShader)->UploadUniformFloat4("u_Color", m_SquareColor);

	Lisa::Renderer::Submit(m_FlatColorShader, m_SquareVA, glm::scale(glm::mat4(1.0f), glm::vec3(1.5f)));
